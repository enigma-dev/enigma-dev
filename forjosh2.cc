...
# 1 "<command-line>"
# 1 "ENIGMAsystem/SHELL/SHELLmain.cpp"
# 29 "ENIGMAsystem/SHELL/SHELLmain.cpp"
...
# 30 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
...
# 31 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2




# 1 "ENIGMAsystem/SHELL/Universal_System/var4.h" 1
# 32 "ENIGMAsystem/SHELL/Universal_System/var4.h"
using std::string;



# 1 "ENIGMAsystem/SHELL/Universal_System/var_te.h" 1
# 29 "ENIGMAsystem/SHELL/Universal_System/var_te.h"
  namespace enigma { enum var_types { vt_real, vt_tstr }; }
# 37 "ENIGMAsystem/SHELL/Universal_System/var4.h" 2
...
struct variant
{
  ...
  long operator| (int x) ; long operator| (unsigned x) ; long operator| (long long x) ; long operator| (unsigned long long x) ; long operator| (float x) ; long operator| (double x) ; long operator| (const char *x) ; long operator| (string x) ; long operator| (const variant x); long operator| (const var &x);
  long operator^ (int x) ; long operator^ (unsigned x) ; long operator^ (long long x) ; long operator^ (unsigned long long x) ; long operator^ (float x) ; long operator^ (double x) ; long operator^ (const char *x) ; long operator^ (string x) ; long operator^ (const variant x); long operator^ (const var &x);
# 122 "ENIGMAsystem/SHELL/Universal_System/var4.h"
...
# 206 "ENIGMAsystem/SHELL/Universal_System/var4.h"
  ...
  long operator| (int x) ; long operator| (unsigned x) ; long operator| (long long x) ; long operator| (unsigned long long x) ; long operator| (float x) ; long operator| (double x) ; long operator| (const char *x) ; long operator| (string x) ; long operator| (const var& x); long operator| (variant x);
  long operator^ (int x) ; long operator^ (unsigned x) ; long operator^ (long long x) ; long operator^ (unsigned long long x) ; long operator^ (float x) ; long operator^ (double x) ; long operator^ (const char *x) ; long operator^ (string x) ; long operator^ (const var& x); long operator^ (variant x);
# 237 "ENIGMAsystem/SHELL/Universal_System/var4.h"
...
bool operator> (int x,var y) ; bool operator> (unsigned x,var y) ; bool operator> (long long x,var y) ; bool operator> (unsigned long long x,var y) ; bool operator> (double x,var y) ; bool operator> (float x,var y) ; bool operator> (const char *x,var y) ; bool operator> (string x,var y) ;
bool operator< (int x,var y) ; bool operator< (unsigned x,var y) ; bool operator< (long long x,var y) ; bool operator< (unsigned long long x,var y) ; bool operator< (double x,var y) ; bool operator< (float x,var y) ; bool operator< (const char *x,var y) ; bool operator< (string x,var y) ;
# 345 "ENIGMAsystem/SHELL/Universal_System/var4.h"
string toString(const variant &a);
string toString(const var &a);
# 36 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2

# 1 "ENIGMAsystem/SHELL/Universal_System/mathnc.h" 1
# 36 "ENIGMAsystem/SHELL/Universal_System/mathnc.h"
...
# 37 "ENIGMAsystem/SHELL/Universal_System/mathnc.h" 2
...
# 38 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Universal_System/estring.h" 1
# 28 "ENIGMAsystem/SHELL/Universal_System/estring.h"
...
# 39 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Universal_System/fileio.h" 1
# 30 "ENIGMAsystem/SHELL/Universal_System/fileio.h"
...
# 40 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Universal_System/terminal_io.h" 1
# 28 "ENIGMAsystem/SHELL/Universal_System/terminal_io.h"
...
# 41 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2




# 1 "ENIGMAsystem/SHELL/API_Switchboard.h" 1
# 46 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2

# 1 "ENIGMAsystem/SHELL/Universal_System/reflexive_types.h" 1
# 36 "ENIGMAsystem/SHELL/Universal_System/reflexive_types.h"
# 1 "ENIGMAsystem/SHELL/Universal_System/multifunction_variant.h" 1
# 28 "ENIGMAsystem/SHELL/Universal_System/multifunction_variant.h"
# 1 "ENIGMAsystem/SHELL/Universal_System/var_te.h" 1
# 29 "ENIGMAsystem/SHELL/Universal_System/multifunction_variant.h" 2
...
# 44 "ENIGMAsystem/SHELL/Universal_System/multifunction_variant.h"
...
# 37 "ENIGMAsystem/SHELL/Universal_System/reflexive_types.h" 2
...
# 44 "ENIGMAsystem/SHELL/Universal_System/reflexive_types.h" 2
...
# 51 "ENIGMAsystem/SHELL/Universal_System/reflexive_types.h" 2
...
# 58 "ENIGMAsystem/SHELL/Universal_System/reflexive_types.h" 2
# 48 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2

# 1 "ENIGMAsystem/SHELL/Universal_System/GAME_GLOBALS.h" 1
# 66 "ENIGMAsystem/SHELL/Universal_System/GAME_GLOBALS.h"
double fps;
# 75 "ENIGMAsystem/SHELL/Universal_System/GAME_GLOBALS.h"
double mouse_button;
double mouse_lastbutton;
double mouse_x;
double mouse_y;
# 50 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Universal_System/ENIGMA_GLOBALS.h" 1
# 31 "ENIGMAsystem/SHELL/Universal_System/ENIGMA_GLOBALS.h"
namespace enigma
{
  extern int nodestroy;
}
# 51 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2

# 1 "ENIGMAsystem/SHELL/libEGMstd.h" 1
# 31 "ENIGMAsystem/SHELL/libEGMstd.h"
string toString(int);
...
# 53 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2


# 1 "ENIGMAsystem/SHELL/Preprocessor_Environment_Editable/LIBINCLUDE.h" 1
# 56 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Preprocessor_Environment_Editable/GAME_SETTINGS.h" 1
# 57 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2

# 1 "ENIGMAsystem/SHELL/Graphics_Systems/graphics_mandatory.h" 1
# 32 "ENIGMAsystem/SHELL/Graphics_Systems/graphics_mandatory.h"
namespace enigma
{
...
void screen_redraw();
# 59 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Platforms/platforms_mandatory.h" 1
# 32 "ENIGMAsystem/SHELL/Platforms/platforms_mandatory.h"
namespace enigma
{
...
# 60 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2

# 1 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/OPENGLStd.h" 1
# 36 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/OPENGLStd.h"
namespace enigma
{
...
# 1 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/GScolors.h" 1
# 28 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/GScolors.h"
enum {
  c_aqua = 0xFFFF00,
  c_black = 0x000000,
  c_blue = 0xFF0000,
...
# 46 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/OPENGLStd.h" 2


# 1 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/GSprmtvs.h" 1
# 28 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/GSprmtvs.h"
...
# 49 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/OPENGLStd.h" 2


# 1 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/GSstdraw.h" 1
# 52 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/GSstdraw.h"
...
# 52 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/OPENGLStd.h" 2


# 1 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/GSblend.h" 1
# 39 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/GSblend.h"
...
# 55 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/OPENGLStd.h" 2




# 1 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/GSmiscextra.h" 1
# 29 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/GSmiscextra.h"
int screen_save(string filename);
# 60 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/OPENGLStd.h" 2
# 62 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/GSsprite.h" 1
# 31 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/GSsprite.h"
# 1 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/../../Universal_System/spritestruct.h" 1
# 27 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/../../Universal_System/spritestruct.h"
...
# 28 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/../../Universal_System/spritestruct.h" 2
...
# 32 "ENIGMAsystem/SHELL/Graphics_Systems/OpenGL/GSsprite.h" 2
...
# 63 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 72 "ENIGMAsystem/SHELL/SHELLmain.cpp"
# 1 "ENIGMAsystem/SHELL/Platforms/Cocoa/CocoaWindow.h" 1
# 28 "ENIGMAsystem/SHELL/Platforms/Cocoa/CocoaWindow.h"
using std::string;
...
# 110 "ENIGMAsystem/SHELL/Platforms/Cocoa/CocoaWindow.h"
int window_set_cursor(double c);
# 142 "ENIGMAsystem/SHELL/Platforms/Cocoa/CocoaWindow.h"
...
# 73 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2




# 1 "ENIGMAsystem/SHELL/Preprocessor_Environment_Editable/IDE_EDIT_resourcenames.h" 1
# 78 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Universal_System/switch_stuff.h" 1
namespace enigma
{
# 19 "ENIGMAsystem/SHELL/Universal_System/switch_stuff.h"
}
# 79 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Universal_System/CallbackArrays.h" 1
# 38 "ENIGMAsystem/SHELL/Universal_System/CallbackArrays.h"
namespace enigma
{
...
# 80 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
...
# 1 "ENIGMAsystem/SHELL/Universal_System/IMGloading.h" 1
# 28 "ENIGMAsystem/SHELL/Universal_System/IMGloading.h"
namespace enigma{
 char* load_bitmap(string filename,int* width,int* height, int* fullwidth, int* fullheight);
}
# 90 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2

# 1 "ENIGMAsystem/SHELL/Audio_Systems/OpenAL/as_basic.h" 1
# 28 "ENIGMAsystem/SHELL/Audio_Systems/OpenAL/as_basic.h"
...
# 92 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2

# 1 "ENIGMAsystem/SHELL/Universal_System/collisions_object.h" 1
# 36 "ENIGMAsystem/SHELL/Universal_System/collisions_object.h"
# 1 "ENIGMAsystem/SHELL/Universal_System/transform_object.h" 1
# 36 "ENIGMAsystem/SHELL/Universal_System/transform_object.h"
# 1 "ENIGMAsystem/SHELL/Universal_System/../Graphics_Systems/OpenGL/graphics_object.h" 1
# 36 "ENIGMAsystem/SHELL/Universal_System/../Graphics_Systems/OpenGL/graphics_object.h"
# 1 "ENIGMAsystem/SHELL/Universal_System/../Graphics_Systems/OpenGL/../../Universal_System/planar_object.h" 1
# 36 "ENIGMAsystem/SHELL/Universal_System/../Graphics_Systems/OpenGL/../../Universal_System/planar_object.h"
# 1 "ENIGMAsystem/SHELL/Universal_System/../Graphics_Systems/OpenGL/../../Universal_System/object.h" 1
# 36 "ENIGMAsystem/SHELL/Universal_System/../Graphics_Systems/OpenGL/../../Universal_System/object.h"
const int self = -1;
const int other = -2;
const int all = -3;
const int noone = -4;
...
# 1 "ENIGMAsystem/SHELL/Universal_System/../Graphics_Systems/OpenGL/../../Universal_System/var4.h" 1
# 44 "ENIGMAsystem/SHELL/Universal_System/../Graphics_Systems/OpenGL/../../Universal_System/object.h" 2
...
# 37 "ENIGMAsystem/SHELL/Universal_System/../Graphics_Systems/OpenGL/../../Universal_System/planar_object.h" 2

# 1 "ENIGMAsystem/SHELL/Universal_System/../Graphics_Systems/OpenGL/../../Universal_System/reflexive_types.h" 1
# 39 "ENIGMAsystem/SHELL/Universal_System/../Graphics_Systems/OpenGL/../../Universal_System/planar_object.h" 2
...
# 37 "ENIGMAsystem/SHELL/Universal_System/../Graphics_Systems/OpenGL/graphics_object.h" 2
namespace enigma
{
...
# 37 "ENIGMAsystem/SHELL/Universal_System/transform_object.h" 2
...
# 37 "ENIGMAsystem/SHELL/Universal_System/collisions_object.h" 2
...
# 94 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2

# 1 "ENIGMAsystem/SHELL/Universal_System/objecttable.h" 1
# 28 "ENIGMAsystem/SHELL/Universal_System/objecttable.h"
namespace enigma
{
  struct objecttable{
    string name;
...
# 96 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Universal_System/object.h" 1
# 97 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Universal_System/instance.h" 1
# 28 "ENIGMAsystem/SHELL/Universal_System/instance.h"
namespace enigma {
...
# 98 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Universal_System/roomsystem.h" 1
# 28 "ENIGMAsystem/SHELL/Universal_System/roomsystem.h"
...
# 1 "ENIGMAsystem/SHELL/Universal_System/var4.h" 1
# 106 "ENIGMAsystem/SHELL/Universal_System/roomsystem.h" 2
...
# 109 "ENIGMAsystem/SHELL/Universal_System/roomsystem.h" 2


extern enigma::roomv room;
# 99 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2

# 1 "ENIGMAsystem/SHELL/Universal_System/globalupdate.h" 1
# 28 "ENIGMAsystem/SHELL/Universal_System/globalupdate.h"
namespace enigma
{
...
# 101 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2

# 1 "ENIGMAsystem/SHELL/Preprocessor_Environment_Editable/IDE_EDIT_wildclass.h" 1
# 103 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Universal_System/WITHconstruct.h" 1
# 104 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Universal_System/OBJaccess.h" 1
# 105 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2

# 1 "ENIGMAsystem/SHELL/Universal_System/simplecollisions.h" 1
# 28 "ENIGMAsystem/SHELL/Universal_System/simplecollisions.h"
...
# 107 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2




# 1 "ENIGMAsystem/SHELL/Universal_System/instance_system.h" 1
# 30 "ENIGMAsystem/SHELL/Universal_System/instance_system.h"
...
# 31 "ENIGMAsystem/SHELL/Universal_System/instance_system.h" 2

# 1 "ENIGMAsystem/SHELL/Universal_System/reflexive_types.h" 1
# 33 "ENIGMAsystem/SHELL/Universal_System/instance_system.h" 2

# 1 "ENIGMAsystem/SHELL/Universal_System/object.h" 1
# 35 "ENIGMAsystem/SHELL/Universal_System/instance_system.h" 2
...
# 112 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Universal_System/syntax_quirks.h" 1
# 113 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2

# 1 "ENIGMAsystem/SHELL/Preprocessor_Environment_Editable/IDE_EDIT_whitespace.h" 1
# 115 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2


# 1 "ENIGMAsystem/SHELL/Universal_System/with.h" 1
# 31 "ENIGMAsystem/SHELL/Universal_System/with.h"
namespace enigma
{
  struct with_iter
  {
...
# 118 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Preprocessor_Environment_Editable/IDE_EDIT_globals.h" 1
# 119 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Preprocessor_Environment_Editable/IDE_EDIT_evparent.h" 1
# 120 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Preprocessor_Environment_Editable/IDE_EDIT_events.h" 1
# 121 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Preprocessor_Environment_Editable/IDE_EDIT_objectdeclarations.h" 1
# 122 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Preprocessor_Environment_Editable/IDE_EDIT_objectaccess.h" 1
# 33 "ENIGMAsystem/SHELL/Preprocessor_Environment_Editable/IDE_EDIT_objectaccess.h"
namespace enigma
{
...
# 123 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Preprocessor_Environment_Editable/IDE_EDIT_objectfunctionality.h" 1
# 124 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Preprocessor_Environment_Editable/IDE_EDIT_roomcreates.h" 1
int instdata[] = { 0 };
# 125 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
# 1 "ENIGMAsystem/SHELL/Preprocessor_Environment_Editable/IDE_EDIT_roomarrays.h" 1
# 126 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
...
# 1 "ENIGMAsystem/SHELL/Universal_System/instance_create.h" 1
# 29 "ENIGMAsystem/SHELL/Universal_System/instance_create.h"
int instance_create(int x,int y,int object)
{
 ...
 switch((int)object)
 {
# 1 "ENIGMAsystem/SHELL/Universal_System/../Preprocessor_Environment_Editable/IDE_EDIT_object_switch.h" 1
# 36 "ENIGMAsystem/SHELL/Universal_System/instance_create.h" 2
    default:
...
namespace enigma
{
  void instance_create_id(int x,int y,int object,int idn)
  {
    ...
    {
# 1 "ENIGMAsystem/SHELL/Universal_System/../Preprocessor_Environment_Editable/IDE_EDIT_object_switch.h" 1
# 54 "ENIGMAsystem/SHELL/Universal_System/instance_create.h" 2
...
# 133 "ENIGMAsystem/SHELL/SHELLmain.cpp" 2
