/**
* @file gmzfilereader.h
* @brief Header file of the GMZ file reader.
*
...
#ifndef GMZFILEREADER_H_INCLUDED
#define GMZFILEREADER_H_INCLUDED
...
#endif // GMZFILEREADER_H_INCLUDED
