...
template<> struct IsString<char*> { enum { v = 1 }; typedef void T; };
template<> struct IsString<const char*> { enum { v = 1 }; typedef void T; };
template<size_t n> struct IsString<char[n]> { enum { v = 1 }; typedef void T; };
template<size_t n> struct IsString<const char[n]> { enum { v = 1 }; typedef void T; };
template<> struct IsString<std::string_view> { enum { v = 1 }; typedef void T; };
template<> struct IsString<std::string> { enum { v = 1 }; typedef void T; };
...
template<typename T>
struct KHas_toString<
    T, std::void_t<typename IsString<decltype(std::declval<T>().toString())>::T>> {
  enum { v = 1 };
};
...
template<typename T>
struct KHas_to_string<
    T, std::void_t<typename IsString<decltype(std::declval<T>().to_string())>::T>> {
  enum { v = 1 };
};
