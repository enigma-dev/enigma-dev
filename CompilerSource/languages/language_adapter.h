...
struct language_adapter {
  ...
  // Sizable utilities
  virtual int link_globals(parsed_object*, EnigmaStruct*, vector<parsed_script*>&, vector<parsed_script*>& tlines) = 0;
  virtual int link_ambiguous(parsed_object*, EnigmaStruct*, vector<parsed_script*>&, vector<parsed_script*>& tlines) = 0;
  ...
  virtual int compile_parseSecondary(map<int,parsed_object*>&,vector<parsed_script*>&, vector<parsed_script*>& tlines, map<int,parsed_room*>&,parsed_object*, const std::set<std::string>&) = 0;
