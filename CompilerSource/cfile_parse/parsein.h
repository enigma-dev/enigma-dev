...
__MINGW_IMPORT int _iob[];	/* An array of FILE imported from DLL. */

//__attribute__ ((MINGW IS A WHORE)) int a;

/*
#if defined __GNUC__ && defined __GNUC_MINOR__
#pragma println_unconditional 1
# define __GNUC_PREREQ(maj, min) \
	((__GNUC__ << 16) + __GNUC_MINOR__ >= ((maj) << 16) + (min))
#else
#pragma println_unconditional 2
# define __GNUC_PREREQ(maj, min) 0
#endif

#pragma println_unconditional 2.718281828
#pragma debug_entry_point

#if defined _FORTIFY_SOURCE && _FORTIFY_SOURCE > 0 && __GNUC_PREREQ (4, 1) && defined __OPTIMIZE__ && __OPTIMIZE__ > 0
#pragma println_unconditional 3
# if _FORTIFY_SOURCE > 1
#pragma println_unconditional 4
#  define __USE_FORTIFY_LEVEL 2
# else
#pragma println_unconditional 5
#  define __USE_FORTIFY_LEVEL 1
# endif
#else
#pragma println_unconditional 6
...
wint_t __NTH (btowc (int __c))
{ return (__builtin_constant_p (__c) && __c >= '\0' && __ }
*/
