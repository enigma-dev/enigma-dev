...
std::string VisualShaderNodeValueNoise::get_caption() const {
	return "ValueNoise";
}

int VisualShaderNodeValueNoise::get_input_port_count() const {
	return 1;
}
...
int VisualShaderNodeValueNoise::get_output_port_count() const {
	return 1;
}
...
std::string VisualShaderNodeValueNoise::get_output_port_name([[maybe_unused]] const int& port) const {
	return "noise";
}
...
std::string VisualShaderNodeValueNoise::generate_code([[maybe_unused]] const int& id, const std::vector<std::string>& input_vars, const std::vector<std::string>& output_vars) const {
...
float VisualShaderNodeValueNoise::get_scale() const {
	return scale;
}
