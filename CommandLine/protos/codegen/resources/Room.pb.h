...
inline void InitDefaults() {
  InitDefaultsRoom_MakerSettings();
  InitDefaultsRoom_Background();
  InitDefaultsRoom_View();
  InitDefaultsRoom_Instance();
  InitDefaultsRoom_Tile();
  InitDefaultsRoom();
}
}  // namespace protobuf_resources_2fRoom_2eproto
namespace buffers {
...
class Room_MakerSettings : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:buffers.resources.Room.MakerSettings) */ {
 ...
 private:
  ...
  friend void ::protobuf_resources_2fRoom_2eproto::InitDefaultsRoom_MakerSettingsImpl();
};
// -------------------------------------------------------------------
...
class Room_Background : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:buffers.resources.Room.Background) */ {
 public:
  ...
  inline Room_Background* New() const PROTOBUF_FINAL { return New(NULL); }

  Room_Background* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  double vspeed_;
  friend struct ::protobuf_resources_2fRoom_2eproto::TableStruct;
  friend void ::protobuf_resources_2fRoom_2eproto::InitDefaultsRoom_BackgroundImpl();
};
// -------------------------------------------------------------------
...
class Room_View : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:buffers.resources.Room.View) */ {
 ...
 private:
  ...
  friend struct ::protobuf_resources_2fRoom_2eproto::TableStruct;
  friend void ::protobuf_resources_2fRoom_2eproto::InitDefaultsRoom_ViewImpl();
};
// -------------------------------------------------------------------
...
class Room_Instance : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:buffers.resources.Room.Instance) */ {
 ...
 private:
  ...
  friend struct ::protobuf_resources_2fRoom_2eproto::TableStruct;
  friend void ::protobuf_resources_2fRoom_2eproto::InitDefaultsRoom_InstanceImpl();
};
// -------------------------------------------------------------------
...
class Room_Tile : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:buffers.resources.Room.Tile) */ {
 public:
  ...
  bool has_xoffset() const;
  void clear_xoffset();
  static const int kXoffsetFieldNumber = 7;
  ::google::protobuf::int32 xoffset() const;
  void set_xoffset(::google::protobuf::int32 value);
  ...
  bool has_yoffset() const;
  void clear_yoffset();
  static const int kYoffsetFieldNumber = 8;
  ::google::protobuf::int32 yoffset() const;
  void set_yoffset(::google::protobuf::int32 value);
  ...
  bool has_xscale() const;
  void clear_xscale();
  static const int kXscaleFieldNumber = 12;
  double xscale() const;
  void set_xscale(double value);
  ...
  bool has_yscale() const;
  void clear_yscale();
  static const int kYscaleFieldNumber = 13;
  double yscale() const;
  void set_yscale(double value);
 ...
 private:
  ...
  double yscale_;
  friend struct ::protobuf_resources_2fRoom_2eproto::TableStruct;
  friend void ::protobuf_resources_2fRoom_2eproto::InitDefaultsRoom_TileImpl();
};
// -------------------------------------------------------------------
...
class Room : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:buffers.resources.Room) */ {
 ...
 private:
  ...
  ::google::protobuf::int32 id_;
  friend struct ::protobuf_resources_2fRoom_2eproto::TableStruct;
  friend void ::protobuf_resources_2fRoom_2eproto::InitDefaultsRoomImpl();
};
// ===================================================================
...
// optional string name = 3;
inline bool Room_Background::has_name() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void Room_Background::set_has_name() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Room_Background::clear_has_name() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Room_Background::clear_name() {
  name_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_name();
}
inline const ::std::string& Room_Background::name() const {
  // @@protoc_insertion_point(field_get:buffers.resources.Room.Background.name)
  return name_.GetNoArena();
}
inline void Room_Background::set_name(const ::std::string& value) {
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:buffers.resources.Room.Background.name)
}
#if LANG_CXX11
inline void Room_Background::set_name(::std::string&& value) {
  set_has_name();
  name_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:buffers.resources.Room.Background.name)
}
#endif
inline void Room_Background::set_name(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:buffers.resources.Room.Background.name)
}
inline void Room_Background::set_name(const char* value, size_t size) {
  set_has_name();
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:buffers.resources.Room.Background.name)
}
inline ::std::string* Room_Background::mutable_name() {
  set_has_name();
  // @@protoc_insertion_point(field_mutable:buffers.resources.Room.Background.name)
  return name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Room_Background::release_name() {
  // @@protoc_insertion_point(field_release:buffers.resources.Room.Background.name)
  clear_has_name();
  return name_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void Room_Background::set_allocated_name(::std::string* name) {
  if (name != NULL) {
    set_has_name();
  } else {
    clear_has_name();
  ...
  // @@protoc_insertion_point(field_set_allocated:buffers.resources.Room.Background.name)
}
...
inline ::std::string* Room_Tile::release_background_name() {
  ...
  clear_has_background_name();
  return background_name_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline void Room::clear_maker_settings() {
  if (maker_settings_ != NULL) maker_settings_->Clear();
...
inline void Room::set_allocated_maker_settings(::buffers::resources::Room_MakerSettings* maker_settings) {
  ...
  if (maker_settings) {
    ...
    if (message_arena != submessage_arena) {
      maker_settings = ::google::protobuf::internal::GetOwnedMessage(
          message_arena, maker_settings, submessage_arena);
    }
    set_has_maker_settings();
  } else {
    clear_has_maker_settings();
