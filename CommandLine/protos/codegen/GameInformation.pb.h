...
#ifndef PROTOBUF_INCLUDED_GameInformation_2eproto
#define PROTOBUF_INCLUDED_GameInformation_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_GameInformation_2eproto 
...
namespace google {
namespace protobuf {
template<> ::buffers::resources::GameInformation* Arena::CreateMaybeMessage<::buffers::resources::GameInformation>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace buffers {
namespace resources {
...
class GameInformation : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:buffers.resources.GameInformation) */ {
 public:
  ...
  inline GameInformation* New() const final {
    return CreateMaybeMessage<GameInformation>(NULL);
  }

  GameInformation* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<GameInformation>(arena);
  }
 ...
 private:
  ...
  bool stay_on_top_;
  bool pause_game_;
  friend struct ::protobuf_GameInformation_2eproto::TableStruct;
};
// ===================================================================
...
inline ::std::string* GameInformation::release_form_caption() {
  ...
  clear_has_form_caption();
  return form_caption_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
#endif  // PROTOBUF_INCLUDED_GameInformation_2eproto
