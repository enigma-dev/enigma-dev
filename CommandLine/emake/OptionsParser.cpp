...
OptionsParser::OptionsParser() : _desc("Options")
{
  ...
  _desc.add_options()
    ...
    ("graphics,g", opt::value<std::string>()->default_value("OpenGL3"), "Graphics System (Direct3D9, Direct3D11, OpenGL1, OpenGL3, OpenGLES2, OpenGLES3, None)")
    ("audio,a", opt::value<std::string>()->default_value("None"), "Audio System (DirectSound, OpenAL, XAudio2, None)")
