...
public class APNGExperiments
	...
	static byte[] i2b(int i)
		{
		return new byte[] { (byte) ((i & 0xFF000000) >> 24),(byte) ((i & 0x00FF0000) >> 16),
	...
	static abstract class PNG_Chunk
		...
		void read(InputStream dis)
			{
			try
				{
				length = (dis.read() << 24) | (dis.read() << 16) | (dis.read() << 8) | dis.read();
	...
	static class IHDR extends PNG_Chunk
		...
		public void repopulate()
			{
			data = new byte[] { (byte) (width & 0xFF000000),(byte) (width & 0x00FF0000),
					(byte) (width & 0x0000FF00),(byte) (width & 0x000000FF),(byte) (height & 0xFF000000),
					(byte) (height & 0x00FF0000),(byte) (height & 0x0000FF00),(byte) (height & 0x000000FF),
	...
	static class acTL extends PNG_Chunk
		...
		public void repopulate()
			{
			data = new byte[] { (byte) (num_frames & 0xFF0000),(byte) (num_frames & 0x00FF0000),
					(byte) (num_frames & 0x0000FF00),(byte) (num_frames & 0x000000FF),
					(byte) (num_plays & 0xFF000000),(byte) (num_plays & 0x00FF0000),
					(byte) (num_plays & 0x0000FF00),(byte) (num_plays & 0x000000FF) };
			updateCRC();
			}
		}
	...
	static class fcTL extends PNG_Chunk
		...
		void repopulate()
			...
			data = new byte[] { (byte) (sequence_number & 0xFF000000),
					(byte) (sequence_number & 0x00FF0000),(byte) (sequence_number & 0x0000FF00),
					(byte) (sequence_number & 0x000000FF),(byte) (width & 0xFF000000),
					(byte) (width & 0x00FF0000),(byte) (width & 0x0000FF00),(byte) (width & 0x000000FF),
					(byte) (height & 0xFF000000),(byte) (height & 0x00FF0000),(byte) (height & 0x0000FF00),
					(byte) (height & 0x000000FF),(byte) (x_offset & 0xFF000000),
					(byte) (x_offset & 0x00FF0000),(byte) (x_offset & 0x0000FF00),
					(byte) (x_offset & 0x000000FF),(byte) (y_offset & 0xFF000000),
					(byte) (y_offset & 0x00FF0000),(byte) (y_offset & 0x0000FF00),
					(byte) (y_offset & 0x000000FF),(byte) (delay_num & 0xFF000000),
					(byte) (delay_num & 0x00FF0000),(byte) (delay_den & 0x0000FF00),
	...
	static class fdAT extends PNG_Chunk
		...
		public void repopulate()
			...
			System.arraycopy(new byte[] { (byte) (sequence_number & 0xFF000000),
					(byte) (sequence_number & 0x00FF0000),(byte) (sequence_number & 0x0000FF00),
		...
		try
			...
			while (is.available() >= 12)
				...
				if (genChunk.istype("acTL"))
					...
					ByteArrayInputStream bais = new ByteArrayInputStream(readme,0,readme.length);
