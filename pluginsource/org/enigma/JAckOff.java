 ...
 * @see JEditorPane
 */
public class JAckOff extends JTextComponent
	{
	private static final long serialVersionUID = 5935521640355897573L;
	 ...
	 */
	public JAckOff(int rows, int columns)
		{
	 ...
	 *  arguments are negative.
	 */
	public JAckOff(String text, int rows, int columns)
		{
	 ...
	 *  arguments are negative.
	 */
	public JAckOff(Document doc, String text, int rows, int columns)
		{
		super();
		this.rows = rows;
	...
	public Dimension getPreferredScrollableViewportSize()
		...
		size.width = (columns == 0) ? size.width : columns * getColumnWidth() + insets.left
				+ insets.right;
	...
	protected class AccessibleJTextArea extends AccessibleJTextComponent
		{
		private static final long serialVersionUID = -8202916875976050854L;
