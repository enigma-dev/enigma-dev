...
// CAPTION //
/////////////
int window_set_caption(std::string caption) { XStoreName(disp,win,caption.c_str()); return 0;}
...
int window_set_size(double w,double h) { XResizeWindow(disp,win,(uint) w,(uint) h); return 0; }
