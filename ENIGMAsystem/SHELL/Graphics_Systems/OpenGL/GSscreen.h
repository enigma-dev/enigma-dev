...
int screen_redraw()
{
    ...
    if (view_visible[(int)view_current])
    {
       ...
       if (vob != -1)
       {
         bool instanceexists=0; enigma::object* vobr;
         ...
         if ((*enigma::instance_iterator).second->object_index==vob || (*enigma::instance_iterator).second->id == vob)
         { instanceexists=1; vobr=(*enigma::instance_iterator).second; break; }
         if (instanceexists) 
         {
