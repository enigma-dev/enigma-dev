...
void draw_primitive_end() { d3d_model_primitive_end(d3dmgr->GetShapesModel()); }
...
void d3d_primitive_end() { d3d_model_primitive_end(d3dmgr->GetShapesModel()); }
...
void d3d_vertex_normal_texture(gs_scalar x, gs_scalar y, gs_scalar z, gs_scalar nx, gs_scalar ny, gs_scalar nz,
  ...
  d3d_model_vertex_normal_texture_color(d3dmgr->GetShapesModel(), x, y, z, nx, ny, nz, tx, ty, draw_get_color(),
                                        draw_get_alpha());
}
