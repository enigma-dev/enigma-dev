...
void draw_enable_alphablend(bool enable) { d3dmgr->SetRenderState(D3DRS_ALPHABLENDENABLE, enable); }
...
void draw_set_alpha_test(bool enable) { d3dmgr->SetRenderState(D3DRS_ALPHATESTENABLE, enable); }

void draw_set_alpha_test_ref_value(unsigned val) { d3dmgr->SetRenderState(D3DRS_ALPHAREF, val); }
