...
void d3d_model_vertex_texture(int id, gs_scalar x, gs_scalar y, gs_scalar z, gs_scalar u, gs_scalar v)
{
  meshes[id]->VertexVector(x, y, z, 0, 0, 0, u, v, c_white, 1); 
}

void d3d_model_vertex_texture_color(int id, gs_scalar x, gs_scalar y, gs_scalar z, gs_scalar u, gs_scalar v, int col, double alpha)
{
...
void d3d_model_vertex_normal_texture(int id, gs_scalar x, gs_scalar y, gs_scalar z, gs_scalar nx, gs_scalar ny, gs_scalar nz, gs_scalar u, gs_scalar v)
{
  meshes[id]->VertexVector(x, y, z, nx, ny, nz, u, v, c_white, 1); 
}

void d3d_model_vertex_normal_texture_color(int id, gs_scalar x, gs_scalar y, gs_scalar z, gs_scalar nx, gs_scalar ny, gs_scalar nz, gs_scalar u, gs_scalar v, int col, double alpha)
{
