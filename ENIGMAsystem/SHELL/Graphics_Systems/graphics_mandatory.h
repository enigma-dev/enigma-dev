...
void graphics_copy_texture_part(int source, int destination, int xoff, int yoff, int w, int h, int x,
                                int y);  //Copy rectangle [xoff,yoff,xoff+w,yoff+h] from source to [x,y] in destination
...
std::string
draw_get_graphics_error();  // Return a const char* error string, if any error has occurred, or an empty string otherwise.
