    ...
    while (!file_text_eof(file)) {
      ...
      if (line.length() > 0) {
        if (line[0] == 'v') {
          ...
          if (hasNormals)
            meshes[id]->AddNormal(normals[(f[2] - 1) * 3], normals[(f[2] - 1) * 3 + 1], normals[(f[2] - 1) * 3 + 2]);
          ...
          if (hasNormals)
            meshes[id]->AddNormal(normals[(f[1 * of + 2] - 1) * 3], normals[(f[1 * of + 2] - 1) * 3 + 1],
                                  normals[(f[1 * of + 2] - 1) * 3 + 2]);
          ...
          if (hasNormals)
            meshes[id]->AddNormal(normals[(f[2 * of + 2] - 1) * 3], normals[(f[2 * of + 2] - 1) * 3 + 1],
                                  normals[(f[2 * of + 2] - 1) * 3 + 2]);
          ...
          if (faceVertices == 4) {
            ...
            if (hasNormals)
              meshes[id]->AddNormal(normals[(f[3 * of + 2] - 1) * 3], normals[(f[3 * of + 2] - 1) * 3 + 1],
                                    normals[(f[3 * of + 2] - 1) * 3 + 2]);
