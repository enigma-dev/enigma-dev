...
void d3d_set_hidden(bool enable) { enigma::d3dHidden = enable; }

void d3d_set_zwriteenable(bool enable) { enigma::d3dZWriteEnable = enable; }
...
void d3d_set_culling(int mode) { enigma::d3dCulling = mode; }
