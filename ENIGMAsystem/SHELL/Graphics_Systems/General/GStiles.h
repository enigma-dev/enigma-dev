...
int tile_add(int background, int left, int top, int width, int height, int x, int y, int depth, double xscale = 1.0,
             double yscale = 1.0, double alpha = 1, int color = 0xFFFFFF);
