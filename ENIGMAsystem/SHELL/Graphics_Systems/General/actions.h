...
inline void action_color(const int color) { draw_set_color(color); }

inline void action_draw_rectangle(const gs_scalar x1, const gs_scalar y1, const gs_scalar x2, const gs_scalar y2,
                                  const int filled) {
...
inline void action_draw_arrow(const gs_scalar x1, const gs_scalar y1, const gs_scalar x2, const gs_scalar y2,
                              const gs_scalar tipSize) {
...
inline void action_draw_ellipse(const gs_scalar x1, const gs_scalar y1, const gs_scalar x2, const gs_scalar y2,
                                const int filled) {
  if (argument_relative) {
    enigma::object_planar* const inst = ((enigma::object_planar*)enigma::instance_event_iterator->inst);
...
inline void action_draw_ellipse_gradient(const gs_scalar x1, const gs_scalar y1, const gs_scalar x2, const gs_scalar y2,
...
inline void action_draw_gradient_hor(const gs_scalar x1, const gs_scalar y1, const gs_scalar x2, const gs_scalar y2,
                                     const int color1, const int color2) {
  if (argument_relative) {
    enigma::object_planar* const inst = ((enigma::object_planar*)enigma::instance_event_iterator->inst);
...
inline void action_draw_gradient_vert(const gs_scalar x1, const gs_scalar y1, const gs_scalar x2, const gs_scalar y2,
                                      const int color1, const int color2) {
  if (argument_relative) {
    enigma::object_planar* const inst = ((enigma::object_planar*)enigma::instance_event_iterator->inst);
...
void action_draw_health(const gs_scalar x1, const gs_scalar y1, const gs_scalar x2, const gs_scalar y2,
                        const double backColor, const int barColor);
void action_draw_health(const gs_scalar x1, const gs_scalar y1, const gs_scalar x2, const gs_scalar y2,
                        const double backColor, const int barColor) {
  ...
  if (argument_relative) {
    enigma::object_planar* const inst = ((enigma::object_planar*)enigma::instance_event_iterator->inst);
    draw_healthbar(x1 + inst->x, y1 + inst->y, x2 + inst->x, y2 + inst->y, health, backColor, realbar2, realbar1, 1, 1,
                   1);
  } else
...
inline void action_draw_life_images(const gs_scalar x, const gs_scalar y, const int image) {
  ...
  for (int i = 0; i < lives; i++) draw_sprite(image, -1, actualX + (i * width), actualY);
}
...
inline void action_draw_text_transformed(const string text, const gs_scalar x, const gs_scalar y,
                                         const gs_scalar horScale, const gs_scalar verScale, const double angle) {
  if (argument_relative) {
    enigma::object_planar* const inst = ((enigma::object_planar*)enigma::instance_event_iterator->inst);
...
inline int draw_self() {
  ...
  draw_sprite_ext(inst->sprite_index, inst->image_index, inst->x, inst->y, inst->image_xscale, inst->image_yscale,
                  inst->image_angle, inst->image_blend, inst->image_alpha);
  return 0;
}  //actions seemed the best place for this

inline int action_draw_self() { return draw_self(); }
...
inline void set_automatic_draw(bool enable) { automatic_redraw = enable; }

inline void draw_enable_drawevent(bool enable) { automatic_redraw = enable; }
