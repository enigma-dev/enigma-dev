...
void draw_line_width_color(gs_scalar x1, gs_scalar y1, gs_scalar x2, gs_scalar y2, gs_scalar wid, int color1,
                           int color2);
...
void draw_rectangle_color(gs_scalar x1, gs_scalar y1, gs_scalar x2, gs_scalar y2, int color1, int color2, int color3,
                          int color4, bool outline = false);
...
void draw_ellipse_color(gs_scalar x1, gs_scalar y1, gs_scalar x2, gs_scalar y2, int col1, int col2,
                        bool outline = false);
...
void draw_sector(gs_scalar x, gs_scalar y, gs_scalar rx, gs_scalar ry, float start_angle, float end_angle,
                 bool outline = false);
...
void draw_triangle_color(gs_scalar x1, gs_scalar y1, gs_scalar x2, gs_scalar y2, gs_scalar x3, gs_scalar y3, int col1,
                         int col2, int col3, bool outline = false);
...
inline void draw_roundrect_color(gs_scalar x1, gs_scalar y1, gs_scalar x2, gs_scalar y2, int col1, int col2,
                                 bool outline) {
...
inline void draw_roundrect_precise_color(gs_scalar x1, gs_scalar y1, gs_scalar x2, gs_scalar y2, int col1, int col2,
                                         bool outline) {
...
void draw_healthbar(gs_scalar x1, gs_scalar y1, gs_scalar x2, gs_scalar y2, float amount, int backcol, int mincol,
                    int maxcol, int direction, bool showback, bool showborder);
void draw_arrow(gs_scalar x1, gs_scalar y1, gs_scalar x2, gs_scalar y2, float arrow_size, float line_size = 1,
                bool outline = false);
