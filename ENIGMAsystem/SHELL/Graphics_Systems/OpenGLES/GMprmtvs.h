...
#define pr_pointlist      1     //GL_POINTS
#define pr_linelist       2     //GL_LINES
#define pr_linestrip      3     //GL_LINE_STRIP
#define pr_trianglelist   4     //GL_TRIANGLES
#define pr_trianglestrip  5     //GL_TRIANGLE_STRIP
#define pr_trianglefan    6     //GL_TRIANGLE_FAN

//Not GML based
#define pr_lineloop       7     //GL_LINE_LOOP
#define pr_quadlist       8     //GL_QUADS
#define pr_quadstrip      9     //GL_QUAD_STRIP
#define pr_polygon       10     //GL_POLYGON
...
int draw_vertex_color(double x, double y, double color, double alpha)
{
     ...
     color=enigma::negmod(color,16777215);
