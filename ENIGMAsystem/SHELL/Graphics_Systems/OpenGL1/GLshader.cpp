...
GLenum shadertypes[5] = {GL_VERTEX_SHADER, GL_FRAGMENT_SHADER, GL_TESS_CONTROL_SHADER, GL_TESS_EVALUATION_SHADER,
                         GL_GEOMETRY_SHADER};
...
string glsl_shader_get_infolog(int id) { return shaders[id]->log; }

void glsl_shader_free(int id) { delete shaders[id]; }
...
void glsl_program_attach(int id, int sid) { glAttachShader(shaderprograms[id]->shaderprogram, shaders[sid]->shader); }

void glsl_program_detach(int id, int sid) { glDetachShader(shaderprograms[id]->shaderprogram, shaders[sid]->shader); }

void glsl_program_set(int id) { glUseProgram(shaderprograms[id]->shaderprogram); }
...
void glsl_program_free(int id) { delete shaderprograms[id]; }
...
void glsl_uniformf(int location, float v0) { glUniform1f(location, v0); }

void glsl_uniformf(int location, float v0, float v1) { glUniform2f(location, v0, v1); }

void glsl_uniformf(int location, float v0, float v1, float v2) { glUniform3f(location, v0, v1, v2); }

void glsl_uniformf(int location, float v0, float v1, float v2, float v3) { glUniform4f(location, v0, v1, v2, v3); }

void glsl_uniformi(int location, int v0) { glUniform1i(location, v0); }

void glsl_uniformi(int location, int v0, int v1) { glUniform2i(location, v0, v1); }

void glsl_uniformi(int location, int v0, int v1, int v2) { glUniform3i(location, v0, v1, v2); }

void glsl_uniformi(int location, int v0, int v1, int v2, int v3) { glUniform4i(location, v0, v1, v2, v3); }

void glsl_uniformui(int location, unsigned v0) { glUniform1ui(location, v0); }
