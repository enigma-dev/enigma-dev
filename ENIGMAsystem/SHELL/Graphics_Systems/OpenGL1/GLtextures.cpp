...
bool texture_mipmapping_supported() { return strstr((char*)glGetString(GL_EXTENSIONS), "glGenerateMipmap"); }

bool texture_anisotropy_supported() {
  return strstr((char*)glGetString(GL_EXTENSIONS), "GL_EXT_texture_filter_anisotropic");
}
...
void texture_anisotropy_filter(int sampler, gs_scalar levels) { enigma::samplerstates[sampler].anisotropy = levels; }
