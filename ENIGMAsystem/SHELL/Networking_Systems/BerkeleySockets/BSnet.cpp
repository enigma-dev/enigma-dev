...
int net_connect_tcp(string addr, string port, bool server) { return net_connect(addr, port, server, 0); }

int net_connect_udp(string localport, bool server) { return net_connect(NULL, localport, server, 1); }
