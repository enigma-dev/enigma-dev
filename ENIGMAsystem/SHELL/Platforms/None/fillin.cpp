...
inline int getMouse(int i) { return -1; }
...
int keyboard_get_map(int key) { return key; }

void keyboard_unset_map() {}

void keyboard_clear(const int key) {}

bool keyboard_check_direct(int key) { return false; }
...
string parameter_string(int num) { return num < enigma::parameterc ? enigma::parameters[num] : ""; }
