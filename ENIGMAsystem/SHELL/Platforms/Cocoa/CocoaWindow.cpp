...
int window_set_visible(int visible) { return cocoa_window_set_visible(visible); }
...
string window_get_caption() { return string(cocoa_window_get_caption()); }
...
int window_get_region_width_scaled() { return window_get_width(); }

int window_get_region_height_scaled() { return window_get_height(); }
...
void window_set_fullscreen(bool full) { cocoa_window_set_fullscreen(full); }
bool window_get_fullscreen() { return cocoa_window_get_fullscreen(); }
...
void windowsystem_write_exename(char* x) {
  ...
  unsigned irx;
  for (irx = 0; resourcefile[irx] != 0; irx++) x[irx] = resourcefile[irx];
  x[irx] = '.';
  x[irx + 1] = 'r';
  x[irx + 2] = 'e';
  x[irx + 3] = 's';
...
namespace enigma_user {
void io_handle() { cocoa_io_handle(); }
...
void clipboard_set_text(string text) { cocoa_clipboard_set_text(text.c_str()); }
...
bool clipboard_has_text() { return cocoa_clipboard_has_text(); }

void window_set_region_scale(double scale, bool adaptwindow) {}
bool window_get_region_scale() { return 1; }
void window_set_region_size(int w, int h, bool adaptwindow) {}

int display_get_width() { return cocoa_get_screen_size(true); }

int display_get_height() { return cocoa_get_screen_size(false); }
}  // namespace enigma_user
