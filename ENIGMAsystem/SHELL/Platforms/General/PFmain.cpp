...
int enigma_main(int argc, char** argv) {
  ...
  #if defined(_WIN32)
  enigma_user::environment_set_variable("IMGUI_FONT_PATH", "C:\\Windows\\Temp\\Assets\\Fonts\\");
  #else
  enigma_user::environment_set_variable("IMGUI_FONT_PATH", enigma_user::filename_change_ext(enigma_user::exeutable_get_pathname(), "") + "_files/fonts/");
  #endif
  initTimer();
  initInput();
