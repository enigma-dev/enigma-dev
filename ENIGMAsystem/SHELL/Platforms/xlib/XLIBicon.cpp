...
void XSetIconFromSprite(Display *display, Window window, int sprID, int subimgID) {
  ...
  data = graphics_copy_texture_pixels(spr.GetTexture(subimgID), &pngwidth, &pngheight);
