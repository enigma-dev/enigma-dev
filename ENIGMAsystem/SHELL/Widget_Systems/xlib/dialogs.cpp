...
static inline bool is_kde() {
  char *env = getenv("XDG_CURRENT_DESKTOP");
  string str_env = env ? env : "";
  return (str_env == "KDE");
}
...
void show_info(string info, int bgcolor, int left, int top, int width, int height, bool embedGameWindow, bool showBorder, bool allowResize, bool stayOnTop, bool pauseGame, string caption) { 
  if (is_kde()) kdialog::show_info(info, bgcolor, left, top, width, height, embedGameWindow, showBorder, allowResize, stayOnTop, pauseGame, caption); 
