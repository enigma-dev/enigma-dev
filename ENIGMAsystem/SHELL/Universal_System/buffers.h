...
void buffer_get_surface(int buffer, int surface, int mode = 0, unsigned offset, int modulo = 0);
void buffer_set_surface(int buffer, int surface, int mode = 0, unsigned offset, int modulo = 0);
