...
void register_callback_before_collision_event(callback_t callback) { before_collision_callbacks.push_back(callback); }
...
void register_callback_particle_updating(callback_t callback) { particle_updating_callbacks.push_back(callback); }
...
void register_callback_clean_up_roomend(callback_t callback) { clean_up_roomend_callbacks.push_back(callback); }
}  // namespace enigma
