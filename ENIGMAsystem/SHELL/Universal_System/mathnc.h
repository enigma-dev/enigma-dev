...
inline int64_t int64(const variant& x) { return x.type == ty_string ? int64((std::string)x) : int64((double)x); }
...
int rectangle_in_circle(ma_scalar x1, ma_scalar sy1, ma_scalar sx2, ma_scalar sy2, ma_scalar x, ma_scalar y,
                        ma_scalar rad);
...
int rectangle_in_triangle(ma_scalar sx1, ma_scalar sy1, ma_scalar sx2, ma_scalar sy2, ma_scalar dx1, ma_scalar dy1,
                          ma_scalar dx2, ma_scalar dy2, ma_scalar dx3, ma_scalar dy3);
...
inline ma_scalar random(ma_scalar low, ma_scalar high) { return low + random(high - low); }
...
static inline ma_scalar random_integer(int low, int high) { return low + random_integer(high - low); }
...
static inline ma_scalar mtrandom(ma_scalar x) { return mtrandom() * x; }
static inline ma_scalar mtrandom(ma_scalar x, ma_scalar y) { return x + mtrandom() * (y - x); }
