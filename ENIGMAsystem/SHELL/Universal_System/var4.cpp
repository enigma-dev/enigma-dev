...
#define ccast(tpc)                                                                                             \
  {                                                                                                            \
    if (type != tpc) {                                                                                         \
      if (type == -1)                                                                                          \
        show_error("Accessing uninitialized variable", 0);                                                     \
      else                                                                                                     \
        show_error(string("Attempting to access ") + (type == 0 ? "real" : type == 1 ? "string" : "pointer") + \
                       " variable as " + (tpc == 0 ? "real" : tpc == 1 ? "string" : "pointer"),                \
                   0);                                                                                         \
    }                                                                                                          \
  }
#else
...
template <typename t>
inline bool vareq(double x, t y) {
  return fabs(x - y) <= 1e-12;
}
template <>
inline bool vareq(double x, double y) {
  return fabs(x - y) < 1e-12;
}
template <>
inline bool vareq(double x, float y) {
  return fabsf(float(x) - y) < 1e-8;
}
template <typename t>
inline bool varneq(double x, t y) {
  return fabs(x - y) > 1e-12;
}
template <>
inline bool varneq(double x, double y) {
  return fabs(x - y) > 1e-12;
}
template <>
inline bool varneq(double x, float y) {
  return fabsf(float(x) - y) >= 1e-8;
}
template <typename t>
inline bool varzero(t x) {
  return !x;
}
template <>
inline bool varzero(float x) {
  return codebloxt(x >= 0 && x <= 0, !x);
}
template <>
inline bool varzero(double x) {
  return codebloxt(x >= 0 && x <= 0, !x);
}
...
#define div0c(x)                                                        \
  {                                                                     \
    if (varzero(x)) return (show_error("Division by zero.", 0), *this); \
  }
#else
#define div0c(x)
#endif
...
variant::operator unsigned() {
  ccast(0);
  return (unsigned int)(rval.d);
}
variant::operator unsigned char() {
  ccast(0);
  return (unsigned char)(rval.d);
}
variant::operator unsigned short() {
  ccast(0);
  return (unsigned short)(rval.d);
}
variant::operator unsigned long() {
  ccast(0);
  return (unsigned long)(rval.d);
}
variant::operator unsigned long long() {
  ccast(0);
  return (unsigned long long)(rval.d);
}
...
types_extrapolate_real_p(variant::variant,
                         : rval(x), sval(), type(real){}) types_extrapolate_string_p(variant::variant,
                                                                                     : rval(0.0), sval(x), type(tstr){})
...
types_extrapolate_real_p(variant& variant::operator=, {
  rval.d = x;
  type = real;
  return *this;
}) types_extrapolate_string_p(variant& variant::operator=, {
  sval = x;
  type = tstr;
  return *this;
}) variant& variant::operator=(const variant x) {
  rval.d = x.rval.d;
  if ((type = x.type) == tstr) sval = x.sval;
  return *this;
}
variant& variant::operator=(const var& x) { return *this = *x; }
variant& variant::operator=(const void* p) {
  type = enigma_user::ty_pointer;
  rval.p = p;
  return *this;
}
...
types_extrapolate_real_p(variant& variant::operator%=, {
  ...
  terror2(real);
  rval.d = fmod(rval.d, x.rval.d);
  return *this;
}
variant& variant::operator%=(const var& x) {
  div0c((*x).rval.d) rval.d = fmod(rval.d, (*x).rval.d);
  return *this;
}

types_extrapolate_real_p(variant& variant::operator<<=, {
  terror(real);
  rval.d = long(rval.d) << int(x);
  return *this;
}) types_extrapolate_string_p(variant& variant::operator<<=, {
  terrortrue();
  return *this;
  ...
  terror2(real);
  rval.d = long(rval.d) << long(x.rval.d);
  return *this;
}
variant& variant::operator<<=(const var& x) { return *this <<= *x; }
...
types_extrapolate_real_p(variant variant::operator+, {
  ...
  terror(tstr);
  return sval + x;
}) variant variant::operator+(const variant x) EVCONST {
  terror(x.type);
  if (x.type == real) return rval.d + x.rval.d;
  return sval + x.sval;
}
variant variant::operator+(const var& x) EVCONST { return *this + *x; }

types_extrapolate_real_p(double variant::operator-, {
  terror(real);
  return rval.d - x;
}) types_extrapolate_string_p(double variant::operator-, {
  terrortrue();
  return rval.d;
}) double variant::operator-(const variant x) EVCONST {
  terror2(real);
  return rval.d - x.rval.d;
}
...
types_extrapolate_real_p(double variant::operator%, {
  ...
  terror2(real);
  div0c(x.rval.d);
  return fmod(rval.d, x.rval.d);
}
double variant::operator%(const var& x) EVCONST {
  div0c((*x).rval.d);
  return fmod(this->rval.d, (*x).rval.d);
}

types_extrapolate_real_p(long variant::operator<<, {
  terror(real);
  return long(rval.d) << long(x);
}) types_extrapolate_string_p(long variant::operator<<, {
  terrortrue();
  return long(rval.d);
}) long variant::operator<<(const variant x) EVCONST {
  terror2(real);
  return long(rval.d) << long(x.rval.d);
}
...
types_extrapolate_real_p(bool variant::operator==, { return type == real and vareq(rval.d, x); })
    types_extrapolate_string_p(bool variant::operator==, {
      return type == tstr and sval == x;
    }) bool variant::operator==(const variant& x) EVCONST {
  return type == x.type and ((x.type == real) ? vareq(rval.d, x.rval.d) : sval == x.sval);
}
...
types_extrapolate_real_p(bool variant::operator!=, { return type != real or varneq(rval.d, x); })
    types_extrapolate_string_p(bool variant::operator!=, {
      return type != tstr or sval != x;
    }) bool variant::operator!=(const variant& x) EVCONST {
  return type != x.type or ((x.type == real) ? varneq(rval.d, x.rval.d) : sval != x.sval);
}
//bool variant::operator!=(const variant x)            { return type != x.type or ((x.type == real) ? rval.d != x.rval.d : sval != x.sval); }
bool variant::operator!=(const var& x) EVCONST { return *this != *x; }

types_extrapolate_real_p(bool variant::operator>=,
                         {
                           return type != real or rval.d >= x - var_e;
                         })  //type != real, then we're string and a priori greater.
    types_extrapolate_string_p(bool variant::operator>=,
                               { return type == tstr and sval >= x; })  //To be more, we must be string anyway.
    bool variant::operator>=(const variant& x) EVCONST {
  return !(type < x.type) and (type > x.type or ((x.type == real) ? rval.d >= x.rval.d : sval >= x.sval));
}
//bool variant::operator>=(const variant x)            { return !(type < x.type) and (type > x.type or ((x.type == real) ? rval.d >= x.rval.d : sval >= x.sval)); }
bool variant::operator>=(const var& x) EVCONST { return *this >= *x; }

types_extrapolate_real_p(bool variant::operator<=,
                         { return type == real and rval.d <= x + var_e; })  //To be less, we must be real anyway.
    types_extrapolate_string_p(bool variant::operator<=,
                               {
                                 return type != tstr or sval <= x;
                               })  //type != tstr, then we're real and a priori less.
    bool variant::operator<=(const variant& x) EVCONST {
  return !(type > x.type) and (type < x.type or ((x.type == real) ? rval.d <= x.rval.d : sval <= x.sval));
}
//bool variant::operator<=(const variant x)            { return !(type > x.type) and (type < x.type or ((x.type == real) ? rval.d <= x.rval.d : sval <= x.sval)); }
...
types_extrapolate_real_p(bool variant::operator<,
                         { return type == real and rval.d < x - var_e; })  //To be less, we must be real anyway.
    types_extrapolate_string_p(bool variant::operator<,
                               { return type != tstr or sval < x; })  //type != tstr, then we're real and a priori less.
    bool variant::operator<(const variant& x) EVCONST {
  return !(type > x.type) and (type < x.type or ((x.type == real) ? rval.d < x.rval.d : sval < x.sval));
}
//bool variant::operator<(const variant x)             { return !(type > x.type) and (type < x.type or ((x.type == real) ? rval.d < x.rval.d : sval < x.sval)); }
...
types_extrapolate_real_p(variant& var::operator=, { return **this = x; })
    types_extrapolate_string_p(variant& var::operator=,
                               { return **this = x; }) variant& var::operator=(const variant x) {
  return **this = x;
}
...
#define types_extrapolate_all_fromvariant(type, op)                              \
  types_extrapolate_real_p(type var::operator op, { return **this op x; })       \
      types_extrapolate_string_p(type var::operator op, { return **this op x; }) \
          type var::operator op(const variant x) EVCONST {                       \
    return **this op x;                                                          \
  }                                                                              \
  type var::operator op(const var& x) EVCONST { return **this op * x; }

types_extrapolate_all_fromvariant(variant&, +=) types_extrapolate_all_fromvariant(variant&, -=)
    types_extrapolate_all_fromvariant(variant&, *=) types_extrapolate_all_fromvariant(variant&, /=)
...
#undef EVCONST
#define EVCONST const
                        types_extrapolate_all_fromvariant(variant, +) types_extrapolate_all_fromvariant(double, -)
                            types_extrapolate_all_fromvariant(double, *) types_extrapolate_all_fromvariant(double, /)
...
#define types_extrapolate_all_fromvariant(type, op)                              \
  types_extrapolate_real_p(type var::operator op, { return **this op x; })       \
      types_extrapolate_string_p(type var::operator op, { return **this op x; }) \
          type var::operator op(const variant& x) const {                        \
    return **this op x;                                                          \
  }                                                                              \
...
types_binary_assign_extrapolate_implement(+, const variant&, terror(real);) types_binary_assign_extrapolate_implement(
    -, const variant&, terror(real);) types_binary_assign_extrapolate_implement(*, const variant&, terror(real);)
                ...
                types_binary_bitwise_assign_extrapolate_implement(&, const variant&, terror(real);)
                    types_binary_bitwise_assign_extrapolate_implement(|, const variant&, terror(real);)
                        types_binary_bitwise_assign_extrapolate_implement (^, const variant&, terror(real);)
                            ...
                            types_binary_extrapolate_real_p(double operator+, const variant&,
                                                            {
                                                              terror(real);
                                                              return x + y.rval.d;
                                                            }) types_binary_extrapolate_string_p(string operator+,
                                                                                                 const variant&,
                                                                                                 {
                                                                                                   terror(tstr);
                                                                                                   return x + y.sval;
                                ...
                                types_binary_extrapolate_real_p(double operator-, const variant&,
                                    ...
                                    types_binary_extrapolate_real_p(double operator*, const variant&,
                                        ...
                                        types_binary_extrapolate_string_p(string operator*, const variant&,
                                                                          {
                                                                            terrortrue();
                                                                            return 0;
                                                                          })
                                                ...
                                                types_binary_extrapolate_string_p(string operator/, const variant&,
                                                    ...
                                                    types_binary_extrapolate_real_p(double operator%, const variant&,
                                                        ...
                                                        types_binary_extrapolate_string_p(string operator%,
                                                            ...
                                                            types_binary_bitwise_extrapolate_real_p(<<, const variant&,
                                                                                                    terror(real);)
    ...
    types_binary_extrapolate_real_p(
        bool operator==, const variant&,
        { return y == x; }) types_binary_extrapolate_string_p(bool operator==, const variant&,
                                                              {
                                                                return y == x;
                                                              }) types_binary_extrapolate_real_p(bool operator!=,
                                                                                                 const variant&,
                                                                                                 { return y != x; })
        types_binary_extrapolate_string_p(
            bool operator!=, const variant&,
            { return y != x; }) types_binary_extrapolate_real_p(bool operator>=, const variant&,
                                                                {
                                                                  return y <= x;
                                                                }) types_binary_extrapolate_string_p(bool operator>=,
                                                                                                     const variant&,
                                                                                                     { return y <= x; })
            types_binary_extrapolate_real_p(bool operator<=, const variant&,
                                            { return y >= x; }) types_binary_extrapolate_string_p(bool operator<=,
                                                                                                  const variant&,
                                                                                                  { return y >= x; })
                types_binary_extrapolate_real_p(bool operator>, const variant&,
                                                { return y < x; }) types_binary_extrapolate_string_p(bool operator>,
                    ...
                    types_binary_extrapolate_real_p(bool operator<, const variant&,
                                                    {
                                                      return y > x;
                                                    }) types_binary_extrapolate_string_p(bool operator<, const variant&,
                                                                                         { return y > x; })

                        types_binary_assign_extrapolate_implement(
                            +, const var&, ) types_binary_assign_extrapolate_implement(-, const var&, )
                            types_binary_assign_extrapolate_implement(*, const var&, )
                                types_binary_assign_extrapolate_implement(/, const var&, )

                                    types_binary_bitwise_assign_extrapolate_implement(
                                        <<,
                                           const var&, ) types_binary_bitwise_assign_extrapolate_implement(>>,
                                                                                                           const var&, )
                                                    ...
                                                    types_binary_extrapolate_real_p(
                                                        ...
                                                        types_binary_extrapolate_real_p(
                                                            ...
                                                            types_binary_extrapolate_real_p(
                                                                ...
                                                                types_binary_extrapolate_real_p(double operator/,
                                                                                                const var&,
                                                                                                {
                                                                                                  div0c((*y).rval.d);
                                                                                                  return x /
                                                                    ...
                                                                    types_binary_extrapolate_string_p(string operator/,
                                                                        ...
                                                                        types_binary_extrapolate_real_p(
                                                                            ...
                                                                            types_binary_extrapolate_string_p(
                                                                                string operator%, const var&,
                                                                                {
                                                                                  terrortrue();
                                                                                  return 0;
                                                                                })

                                                                                types_binary_bitwise_extrapolate_real_p(
                                                                                    <<, const var&, )
                        ...
                        types_binary_extrapolate_string_p(bool operator>=, const var&, { return y <= x; })
                            types_binary_extrapolate_real_p(bool operator<=, const var&, { return y >= x; })
                                types_binary_extrapolate_string_p(bool operator<=, const var&, { return y >= x; })
                                    types_binary_extrapolate_real_p(bool operator>, const var&, { return y < x; })
                                        types_binary_extrapolate_string_p(bool operator>, const var&, { return y < x; })
                                            types_binary_extrapolate_real_p(bool operator<, const var&,
                                                                            { return y > x; })
                                                types_binary_extrapolate_string_p(bool operator<, const var&,
                                                                                  { return y > x; })
