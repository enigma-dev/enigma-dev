...
void b2d_world_create(int pixeltometerscale)
{
  ...
  /** studio's messed up world creation just auto binds it to the current room
      thats stupid thus why i overloaded the function and provided an extra
...
{
  // draws all the fixtures and their rotations in the room for u, wants constants, im not doing that that
