...
bool gamepad_is_supported() { return true; }
...
int gamepad_get_max_device_count() { return XUSER_MAX_COUNT; }
...
int gamepad_axis_count(int device) { return 2; }
...
WORD digitalButtons[20] = {XINPUT_GAMEPAD_A,
                           XINPUT_GAMEPAD_X,
                           XINPUT_GAMEPAD_B,
                           XINPUT_GAMEPAD_Y,
