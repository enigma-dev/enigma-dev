...
void path_start(unsigned pathid, cs_scalar speed, unsigned endaction, bool absolute) {
  ...
  enigma::extension_path *const inst_paths =
      enigma::extension_cast::as_extension_path(enigma::instance_event_iterator->inst);
...
bool path_update() {
  ...
  if (size_t(inst_paths->path_index) >= enigma::path_idmax || fzero(inst_paths->path_speed)) return false;
...
bool path_exists(unsigned pathid) { return (pathid < enigma::path_idmax && enigma::pathstructarray[pathid]); }
...
cs_scalar path_get_center_x(unsigned pathid) { return enigma::pathstructarray[pathid]->centerx; }

cs_scalar path_get_center_y(unsigned pathid) { return enigma::pathstructarray[pathid]->centery; }

int path_get_number(unsigned pathid) { return enigma::pathstructarray[pathid]->pointarray.size(); }

cs_scalar path_get_point_x(unsigned pathid, unsigned n) { return enigma::pathstructarray[pathid]->pointarray[n].x; }

cs_scalar path_get_point_y(unsigned pathid, unsigned n) { return enigma::pathstructarray[pathid]->pointarray[n].y; }
...
int path_get_precision(unsigned pathid) { return enigma::pathstructarray[pathid]->precision; }

cs_scalar path_get_length(unsigned pathid) { return enigma::pathstructarray[pathid]->total_length; }

bool path_get_kind(unsigned pathid) { return enigma::pathstructarray[pathid]->smooth; }

bool path_get_closed(unsigned pathid) { return enigma::pathstructarray[pathid]->closed; }
