...
void WindowIdSetParentWindowId(wid_t windowId, wid_t parentWindowId) {
  ...
  SetWindowLongPtr(child, GWL_STYLE, GetWindowLongPtr(child, GWL_STYLE) & ~(WS_CAPTION | WS_BORDER | WS_THICKFRAME | WS_MINIMIZE | WS_MAXIMIZE | WS_SYSMENU | WS_SIZEBOX) | WS_CHILD);
