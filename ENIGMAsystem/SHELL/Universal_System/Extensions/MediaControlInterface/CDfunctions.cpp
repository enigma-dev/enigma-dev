...
void cd_open_door() { mciSendString("set cdaudio door open wait", NULL, 0, NULL); }

void cd_close_door() { mciSendString("set cdaudio door closed wait", NULL, 0, NULL); }
...
void cd_pause() { mciSendString("pause cdaudio", NULL, 0, NULL); }

void cd_resume() { mciSendString("resume cdaudio", NULL, 0, NULL); }

void cd_stop() { mciSendString("stop cdaudio", NULL, 0, NULL); }
