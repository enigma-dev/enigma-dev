...
void physics_fixture_mass_properties(int id, double mass, double local_center_x, double local_center_y,
                                     double inertia) {
  get_fixture(sb2dfixture, id);
...
void physics_pause_enable(bool pause) { systemPaused = pause; }
