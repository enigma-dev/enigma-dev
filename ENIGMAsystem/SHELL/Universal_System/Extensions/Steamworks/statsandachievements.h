...
/*
    ...
    nothing will happen. Calls gc_statsandachievements::set_achievement().
...
/*
    ...
    panel. Calls gc_statsandachievements::get_achievement().
...
/*
    ...
    Calls gc_statsandachievements::clear_achievement().
...
/*
    ...
    gc_statsandachievements::set_stat_int().
...
/*
    ...
    have been previously defined on the Steamworks control panel accounts page for your game and the string 
    that is passed to the function should match that used as the API Name on the control panel. Calls
    gc_statsandachievements::set_stat_float().
...
/*
    ...
    the amount of game time since the last call to the function. Calls gc_statsandachievements::set_stat_average_rate().
...
/*
    ...
    gc_statsandachievements::get_stat_int().
...
/*
    ...
    been previously defined on the Steamworks control panel accounts page for your game and the string that 
    is passed to the function should match that used as the API Name on the control panel. Calls
    gc_statsandachievements::get_stat_float().
...
/*
    ...
    gc_statsandachievements::get_stat_average_rate().
...
/*
    ...
    gc_statsandachievements::reset_all_stats().
...
/*
    ...
    their default values use the steam_reset_all_stats() instead. Calls gc_statsandachievements::reset_all_stats().
