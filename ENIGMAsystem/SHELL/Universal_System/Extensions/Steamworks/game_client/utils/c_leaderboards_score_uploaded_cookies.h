...
/*
  Whenever a c_leaderboards::upload_score() is called, a new object from this class will be instantiated 
...
class c_leaderboards_score_uploaded_cookies : public c_leaderboards_cookies {
 public:
