...
/**
 * @brief Whenever a @c GCLeaderboards::upload_score() is called, a new object from this class will be instantiated 
...
#ifndef GC_LEADERBOARDS_SCORE_UPLOADED_COOKIES_H
#define GC_LEADERBOARDS_SCORE_UPLOADED_COOKIES_H
...
class GCLeaderboardsScoreUploadedCookies : public GCLeaderboardsCookies {
 public:
  /**
   * @brief GCLeaderboardsScoreUploadedCookies constructor.
   * 
...
#endif  // GC_LEADERBOARDS_SCORE_UPLOADED_COOKIES_H
