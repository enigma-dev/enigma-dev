...
class GameClient {
  ...
  */
  ...
  /*
    ...
    return true if you're using Steam DRM or calling gc_main::restart_app_if_necessary().
  ...
  */
  ...
  /*
    ...
    steamworks::gameclient::get_image_rgba() to create an appropriately sized buffer 
