...
class ShortJSONConverter {
 private:
  ...
  /*
    This array keeps track of next tokens so that we catch syntax errors.
  */
  ...
  /*
              If current level is a JSON "object", we need to keep track of keys' indices for each value.
