...
void ds_list_replace(const unsigned int id, const int pos, const variant val);
...
map<unsigned int, grid<variant> > ds_grids;
unsigned int ds_grids_maxid = 0;
...
map<unsigned int, multimap<variant, variant> > ds_maps;
unsigned int ds_maps_maxid = 0;
...
map<unsigned int, vector<variant> > ds_lists;
unsigned int ds_lists_maxid = 0;
...
int ds_list_find_index(const unsigned int id, const variant val)
{
    ...
    for (int i = 0; i < ds_lists[id].size(); i++)
    {
...
map<unsigned int, multimap<variant, variant> > ds_prioritys;
unsigned int ds_prioritys_maxid = 0;
...
map<unsigned int, deque<variant> > ds_queues;
unsigned int ds_queues_maxid = 0;
...
map<unsigned int, deque<variant> > ds_stacks;
unsigned int ds_stacks_maxid = 0;
