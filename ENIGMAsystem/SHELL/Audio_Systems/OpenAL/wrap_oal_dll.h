/** Code donated to the ENIGMA Development Environment by KCat, **\
*** author of ALURE. I am releasing it under the terms of the   ***
*** GNU General Public License, version 3 or later, as with the ***
\** other files in the ENIGMA project.                          **/

/* When AL_SYSTEM_HEADER is set, this file includes the typical  *\
** OpenAL headers, and ALURE will behave normally. When not set, **
** ALURE will be made to use the external function pointers that **
** are defined below instead of direct AL calls, allowing ENIGMA **
\* to load the functions from an internal copy of OpenAL32.dll.  */

#ifndef _WRAP_OAL__H
#define _WRAP_OAL__H

#ifdef AL_SYSTEM_HEADER
#  include <AL/al.h>
#  include <AL/alc.h>
#else
