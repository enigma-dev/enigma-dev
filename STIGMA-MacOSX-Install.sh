...
if [ -f "/opt/local/bin/port" ]; then
  ...
  brew install curl wget gdb make cmake pkg-config flac opusfile mpg123 libmodplug libsndfile libogg libsndfile libvorbis vorbis-tools sdl2 sdl2_mixer dumb boost
