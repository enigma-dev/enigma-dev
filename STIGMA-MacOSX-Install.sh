...
brew install openjdk@8 make cmake pkg-config grpc protobuf-c glew glm libpng libsndfile libogg libvorbis vorbis-tools box2d dumb SDL2 SDL2_mixer freetype libffi rapidjson libyaml libvpx pugixml yaml-cpp boost flac mpg123 libmodplug opus opusfile fluidsynth zlib
