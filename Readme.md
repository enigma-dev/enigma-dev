...
## Install
In order to keep the ENIGMA repository small and fast binary files are excluded. To install you will need to obtain the binary files for your chosen platform. Please read the `building.txt` file for more information, and like wise for the Command Line Interface.
