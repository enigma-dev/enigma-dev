...
Section "STIGMA Sources"
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT}\STIGMA Development Environment (x64).lnk" "$INSTDIR\${PRODUCT}-Uninstaller-x86_64.exe" "" "$INSTDIR\${PRODUCT}-Uninstaller-x86_64.exe" 0
